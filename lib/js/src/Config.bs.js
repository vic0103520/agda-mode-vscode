...
function parseAgdaPaths(raw) {
  if (!Array.isArray(raw) && (raw === null || typeof raw !== "object") && typeof raw !== "number" && typeof raw !== "string" && typeof raw !== "boolean") {
    return [];
  } else if (Array.isArray(raw)) {
    return Core__Array.filterMap(raw, (function (s) {
...
function addAgdaPath(logChannel, path) {
  ...
  if (inTestingMode.contents) {
    ...
    return Vscode.workspace.getConfiguration("agdaMode", undefined).update("connection.paths", newPaths.toReversed(), 1, undefined);
  }
}
...
function setAgdaPaths(logChannel, paths) {
  if (inTestingMode.contents) {
    ...
    return Vscode.workspace.getConfiguration("agdaMode", undefined).update("connection.paths", paths.toReversed(), 1, undefined);
  }
}
